...
import com.yifanlu.Josh.ConsoleEventKeyboard;
import com.yifanlu.Josh.ConsoleEventMouse;
import com.yifanlu.Josh.ConsoleEventBufferChanged;
...
public class JoshInBuffer extends JoshBuffer {
     ...
     */
	public JoshInBuffer(ConsoleHandle handle){ this.setHandle(handle); }
	 ...
	 */
	public ConsoleEvent readConsoleInput(){ return readConsoleInput(1); }
	 ...
	 */
	public void writeConsoleInput(ConsoleEvent event){ writeConsoleInput(event,1); }

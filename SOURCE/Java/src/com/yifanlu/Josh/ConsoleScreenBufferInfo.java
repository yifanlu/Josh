...
public class ConsoleScreenBufferInfo extends ConsoleAttribute {
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + (this.cursorPosition != null ? this.cursorPosition.hashCode() : 0);
        hash = 59 * hash + (this.window != null ? this.window.hashCode() : 0);
        hash = 59 * hash + (this.maximumWindowSize != null ? this.maximumWindowSize.hashCode() : 0);
        return hash;
    }

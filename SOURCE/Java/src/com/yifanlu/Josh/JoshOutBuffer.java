...
public class JoshOutBuffer extends JoshBuffer {
     ...
     */
    public void scrollConsoleScreenBuffer(ConsoleSmallRect block, ConsoleCoord destination) {
        scrollConsoleScreenBuffer(block, destination, new ConsoleCharInfo(' ', new ConsoleAttribute(0)));
    }
     ...
     */
    public void scrollConsoleScreenBuffer(ConsoleSmallRect block, ConsoleCoord destination, ConsoleCharInfo fill) {
        scrollConsoleScreenBuffer(block, new ConsoleSmallRect(-1, -1, -1, -1), destination, fill);
    }

...
public class ConsoleEventMouse extends ConsoleEvent {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + (this.mousePosition != null ? this.mousePosition.hashCode() : 0);
        hash = 53 * hash + this.buttonState;
        hash = 53 * hash + this.controlKeyState;
        hash = 53 * hash + this.eventFlags;
        return hash;
    }

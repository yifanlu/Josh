...
import com.yifanlu.Josh.ConsoleColor;
...
public class JoshOutput extends JoshBuffer {
     ...
     */
	public JoshOutput(ConsoleHandle handle){ this.setHandle(handle); methods = new JoshOutBuffer(handle); }
	
	/** 
	 * Clears the console buffer to a blank black screen.
	 */
	public void clearConsole(){ clearConsole(ConsoleColor.BLACK(false)); }
	...
	public void printhighlightln(Object ... objects) throws IllegalArgumentException{
		...
		if(count % 2 == 0) methods.setConsoleTextAttribute((ConsoleAttribute)black);
	}
	...
	public void printcolorln(Object ... objects) throws IllegalArgumentException{
		...
		if(count % 2 == 0) methods.setConsoleTextAttribute((ConsoleAttribute)ConsoleColor.WHITE(false));
	}
}
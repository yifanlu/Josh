...
public class ConsoleColor extends ConsoleAttribute {
	...
	public ConsoleColor(boolean red, boolean blue, boolean green, boolean bright, boolean background){
		if(red)
			addAttributes(this.FOREGROUND_RED);
		if(blue)
			addAttributes(this.FOREGROUND_BLUE);
		if(green)
			addAttributes(this.FOREGROUND_GREEN);
		if(bright)
			addAttributes(this.FOREGROUND_INTENSITY);
		if(background)
			makeBackground();
	}
     ...
     */
	public static final ConsoleColor RED(boolean bright){ return new ConsoleColor(true,false,false,bright,false); }
	
	/**
	 * @deprecated Same as {@code RED(false)}
	 * @see #RED(boolean)
	 */
	public static final ConsoleColor RED(){ return RED(false); }
     ...
     */
	public static final ConsoleColor BLUE(boolean bright){ return new ConsoleColor(false,true,false,bright,false); }
	
	/**
	 * @deprecated Same as {@code BLUE(false)}
	 * @see #BLUE(boolean)
	 */
	public static final ConsoleColor BLUE(){ return BLUE(false); }
     ...
     */
	public static final ConsoleColor GREEN(boolean bright){ return new ConsoleColor(false,false,true,bright,false); }
	
	/**
	 * @deprecated Same as {@code GREEN(false)}
	 * @see #GREEN(boolean)
	 */
	public static final ConsoleColor GREEN(){ return GREEN(false); }
     ...
     */
	public static final ConsoleColor YELLOW(boolean bright){ return new ConsoleColor(true,false,true,bright,false); }
	
	/**
	 * @deprecated Same as {@code YELLOW(false)}
	 * @see #YELLOW(boolean)
	 */
	public static final ConsoleColor YELLOW(){ return YELLOW(false); }
     ...
     */
	public static final ConsoleColor CRYAN(boolean bright){ return new ConsoleColor(false,true,true,bright,false); }
	
	/**
	 * @deprecated Same as {@code CRYAN(false)}
	 * @see #CRYAN(boolean)
	 */
	public static final ConsoleColor CRYAN(){ return CRYAN(false); }
     ...
     */
	public static final ConsoleColor MAGENTA(boolean bright){ return new ConsoleColor(true,true,false,bright,false); }
	
	/**
	 * @deprecated Same as {@code MAGENTA(false)}
	 * @see #MAGENTA(boolean)
	 */
	public static final ConsoleColor MAGENTA(){ return MAGENTA(false); }
     ...
     */
	public static final ConsoleColor WHITE(boolean bright){ return new ConsoleColor(true,true,true,bright,false); }
	
	/**
	 * @deprecated Same as {@code WHITE(false)}
	 * @see #WHITE(boolean)
	 */
	public static final ConsoleColor WHITE(){ return WHITE(false); }
     ...
     */
	public static final ConsoleColor BLACK(boolean bright){ return new ConsoleColor(false,false,false,bright,false); }
	
	/**
	 * @deprecated Same as {@code BLACK(false)}
	 * @see #BLACK(boolean)
	 */
	public static final ConsoleColor BLACK(){ return BLACK(false); }
}
...
public class ReadWriteOutput {
    public static void main(String[] args) {
    	...
    	/* Copying and pasting characters */
 		...
 		// Read the characters
 		ConsoleCharInfo[] toPaste = Josh.outBuffer.readConsoleOutput(new ConsoleCoord(9,1), new ConsoleCoord(0,0));
 		
 		// Write the characters
 		Josh.outBuffer.writeConsoleOutput(toPaste, new ConsoleCoord(9,1), new ConsoleCoord(3,3));
    }
}
